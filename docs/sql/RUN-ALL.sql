...
-- It is the five separate files concatenated in dependency order, and
-- every one of them is idempotent, so running this twice changes
...
--   5. verify-security.sql proves the refusals — prints PASS lines
--
-- The last section prints NOTICEs. Read them: every line should say
-- PASS, and the final one says "all checks passed". If any raises an
-- exception, nothing after it ran — send me the message.
-- =====================================================================
