...
/* .public.json — generated by scripts/partition-content.mjs. Carries every
   question's id, heading and stem, but the five statements (with their
   true/false values and explanations) only for the free sample. The rest come
   from premium_content through the premium-content function, after the
   database has checked entitlement. Importing the raw .json here ships 424
   paid question sets to every visitor. */
import baseRaw from './questions.base.public.json'
import annotationsRaw from './annotations.json'
import recallRaw from './recall.json'
import extractedRaw from './extracted.public.json'
